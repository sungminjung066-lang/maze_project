...
Unity와 Oculus XR 환경을 활용하여 플레이어가 가상 공간에서 미로를 체험할 수 있도록 구현했습니다.
...
1. VR 기기(Oculus Quest 등)에 APK 설치
2. VR 기기에서 애플리케이션 실행
...
![씬1 미로](IMG/씬1_미로_구조.jpg)
![씬2 미로](IMG/씬2_미로_구조.png)

---

## 🎥 플레이 영상

[시연 영상](Video/시연영상.mp4)
